...
class Population:
    def __init__(self,μ,σ=4,N=10**5,T = 200,n=10,r=.99,γ=1/3,β=10,π=20,state_space = np.round(np.linspace(-50,50,1001),1),initial_v=0,update_rate = 1):
        self.μ = μ
        self.σ = σ
        self.N = N
        self.n = n
        ...
        strategies = dyn_prog(T,self.p,self.v,self.prob_matrixes)[2]
